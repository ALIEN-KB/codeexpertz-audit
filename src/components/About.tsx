          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-lg text-gray-300 leading-relaxed mb-6">
                ...
                With years of experience in the industry, we've helped businesses of all sizes achieve their digital goals.
              </p>
              <p className="text-lg text-gray-300 leading-relaxed">
                Our expertise spans across modern web technologies, mobile development, and emerging AI solutions. 
                We believe in delivering not just code, but complete solutions that drive business growth.
              </p>
            </div>
            ...
            <Button 
              size="lg"
              className="bg-gradient-to-r from-cyan-500 to-purple-500 hover:from-cyan-600 hover:to-purple-600 text-white font-semibold px-8 py-3 rounded-full transition-all duration-300 transform hover:scale-105"
            >
              Get Started Today
          ...
          <div className="space-y-8">
            <div className="grid grid-cols-2 gap-6">
              {stats.map((stat, index) => (
                <Card key={index} className="bg-slate-800/80 border-slate-700 backdrop-blur-sm">
              ...
              <CardContent className="p-0">
                <div className="h-64 bg-gradient-to-br from-cyan-500/20 to-purple-500/20 flex items-center justify-center">
                  <div className="text-center text-white">
                    ...
                    <p className="text-sm text-gray-400">Dedicated professionals ready to help</p>
                  </div>
                </div>
              </CardContent>
            </Card>
